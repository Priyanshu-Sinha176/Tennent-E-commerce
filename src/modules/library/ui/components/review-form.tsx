        ...
        <Form {...form} >
            ...
            <form className="flex flex-col gap-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormField control={form.control} name="description" render={({ field }) => (
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                            ...
                            <Textarea {...field} disabled={isPreview} placeholder="Want to leave a written review ?" />
                ...
                {!isPreview && (
                    ...
                    < Button variant="elevated" disabled={createReview.isPending || updateReview.isPending} type="submit"
                        size="lg" className="bg-black text-white hover:bg-pink-500 hover:text-primary w-fit">
...
export const ReviewFormSkeleton = () => {
    ...
    return (
        ...
        <div className="flex flex-col gap-y-4">
            ...
            < Button variant="elevated" disabled type="button" size="lg"
                className="bg-black text-white hover:bg-pink-500 hover:text-primary w-fit">
